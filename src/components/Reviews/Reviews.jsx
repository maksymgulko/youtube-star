    ...
    <div className={s.container}>
      ...
      >
        ...
        <SwiperSlide>
          <div className={s.review}>
            <p>
              ...
              кулінарії, тепер в мене є справа мого життя та додатковий
              заробіток до пенсії. Дякую вам велике ❤️
            </p>
            <p>Ольга</p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className={s.review}>
            <p>
              Хочу подякувати вам за курс,живу за кордоном пройшла ваше
              навчання, створила канал та знімаю розважальний контент зі своїми
              дітьми, швидко досягла монетизації на Shorts, це було легко💲.
              Зараз буду створювати другий канал, так як це просто заробляти тут
              гроші 💰
            </p>
            <p>Ірина</p>
          </div>
